...
public class WebChat extends BaseTest { // Extends BaseTest, not BasePage

    @Test
    public void testInboundWebChatFlow() throws InterruptedException {
        ...
        inbox.openTeamInbox();
        inbox.selectChannel(Channel.WEBCHAT);
        inbox.clickFirstCardWebChat();
